...
Originally written by Katherine, updated 10/12/2022 by Ruby. Recommend running this tutorial using RStudio.
...
The gene expression data is a data frame structure, with columns representing different prostate cancer samples and rows representing different genes as shown in the first 10 rows of the data frame. The values indicate levels of gene expression of a gene for a given sample.
